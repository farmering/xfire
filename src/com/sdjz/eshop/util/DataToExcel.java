...
public class DataToExcel {
	...
	public static List getTableList() {
		String sql = "select object_name From user_objects Where object_type='TABLE' and object_name like 'PARAM'";
	...
	public static String TableStructInfoToExcel(List list, String path)
		...
		String[] tableFiled = {"column_name", "data_type", "data_length",
				...
				"comments" };
		try {
			FileName = path + "\\" + System.currentTimeMillis()+"CSN数据库中表结构.xls";
			...
			for (int z = 0; z < list.size(); z++) {
				...
				wb.setSheetName(z, ((List)list.get(z)).get(0).toString());
